...
vector, multilayer-perceptron, and Explainable Boosting Machine regressors.
QB, team defense/special-teams (DST), kicker, RB/WR/TE, and individual
defensive player (IDP) prediction are all implemented; see the Positions table
below for scope and caveats.
